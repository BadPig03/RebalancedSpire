    ...
    internal static void Initialize()
    {
        ...
        RitsuLibFramework.RegisterModSettings(RebalancedSpireMain.ModId, p => p
            ...
            .AddSection("the_ironclad", s => s
                ...
                .AddToggle("haze", L("the_silent.section.haze.title"), ui.Haze, L("the_silent.section.haze.description"))
                ...
                .AddToggle("mirage", L("the_silent.section.mirage.title"), ui.Mirage, L("the_silent.section.mirage.description"))
                ...
                .AddToggle("fuel", L("the_defect.section.fuel.title"), ui.Fuel, L("the_defect.section.fuel.description"))
                ...
                .AddToggle("rocket_punch", L("the_defect.section.rocket_punch.title"), ui.RocketPunch, L("the_defect.section.rocket_punch.description"))
