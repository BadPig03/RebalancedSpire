...
public static class SkulkingColonyPatch
{
    ...
    {
        await DamageCmd.Attack(ZoomDamage).FromMonster(instance).WithAttackerAnim("AttackHeavy", 0.25f).WithAttackerFx(null, SrcHelpers.GetSfx(instance, "AttackSfx")).WithHitFx("vfx/vfx_attack_slash").Execute(null);
