...
public static class VantomPatch
{
    ...
    [HarmonyPatch(typeof(Vantom), "DismemberDamage", MethodType.Getter)]
    [HarmonyPostfix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(Vantom), "AfterAddedToRoom")]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(Vantom), "GenerateMoveStateMachine")]
    [HarmonyPrefix]
    [UsedImplicitly]
