...
public static class SlimedBerserkerPatch
{
    ...
    {
        await DamageCmd.Attack(SmotherDamage).FromMonster(instance).WithAttackerAnim("Attack", 0.2f).WithAttackerFx(null, SrcHelpers.GetSfx(instance, "AttackSfx")).Execute(null);
    }
