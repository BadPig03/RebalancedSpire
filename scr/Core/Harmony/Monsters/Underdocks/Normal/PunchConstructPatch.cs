...
public static class PunchConstructPatch
{
    ...
    private static int ArtifactPowerAmount => 1;
    ...
    {
        await PowerCmd.Apply<ArtifactPower>(instance.Creature, ArtifactPowerAmount, instance.Creature, null);
    ...
    [HarmonyPatch(typeof(PunchConstruct), nameof(PunchConstruct.GenerateMoveStateMachine))]
    [HarmonyPrefix]
    [UsedImplicitly]
