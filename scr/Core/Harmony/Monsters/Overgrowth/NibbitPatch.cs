...
public static class NibbitPatch
{
    ...
    private static async Task SliceMove(Nibbit instance, IReadOnlyList<Creature> targets)
    {
    ...
    private static bool PreFix_GenerateMoveStateMachine(Nibbit __instance, ref MonsterMoveStateMachine __result)
    {
        ...
        MoveState moveState2 = new MoveState("SLICE_MOVE", t => SliceMove(__instance, t), new SingleAttackIntent(SliceDamage), new DefendIntent());
