...
public static class CrusherPatch
{
    ...
    private static bool PreFix(Crusher __instance, ref MonsterMoveStateMachine __result)
    {
        ...
        MoveState moveState = new MoveState("THRASH_MOVE", __instance.ThrashMove, new SingleAttackIntent(__instance.ThrashDamage));
        ...
        MoveState moveState4 = new MoveState("ADAPT_MOVE", __instance.AdaptMove, new BuffIntent());
        MoveState moveState5 = new MoveState("GUARDED_STRIKE_MOVE", __instance.GuardedStrikeMove, new SingleAttackIntent(__instance.GuardedStrikeDamage), new DefendIntent());
