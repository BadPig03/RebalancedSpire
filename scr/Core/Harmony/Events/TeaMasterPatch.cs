...
public static class TeaMasterPatch
{
    ...
    [HarmonyPatch(typeof(TeaMaster), nameof(TeaMaster.CanonicalVars), MethodType.Getter)]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(TeaMaster), nameof(TeaMaster.IsAllowed))]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(TeaMaster), nameof(TeaMaster.GenerateInitialOptions))]
    [HarmonyPrefix]
    [UsedImplicitly]
