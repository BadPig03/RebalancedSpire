...
public static class FollowThroughPatch
{
    ...
    [HarmonyPatch(typeof(FollowThrough), nameof(FollowThrough.CanonicalVars), MethodType.Getter)]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(FollowThrough), nameof(FollowThrough.ShouldGlowGoldInternal), MethodType.Getter)]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(FollowThrough), nameof(FollowThrough.OnPlay))]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(FollowThrough), nameof(FollowThrough.OnUpgrade))]
    [HarmonyPrefix]
    [UsedImplicitly]
