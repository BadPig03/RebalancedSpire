...
public static class SpurPatch
{
    ...
    [HarmonyPatch(typeof(Spur), nameof(Spur.ExtraHoverTips), MethodType.Getter)]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(Spur), nameof(Spur.CanonicalVars), MethodType.Getter)]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(Spur), nameof(Spur.CanonicalKeywords), MethodType.Getter)]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(Spur), nameof(Spur.OnPlay))]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(Spur), nameof(Spur.OnUpgrade))]
    [HarmonyPrefix]
    [UsedImplicitly]
