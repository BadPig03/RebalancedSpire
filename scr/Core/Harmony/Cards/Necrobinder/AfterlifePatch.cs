...
public static class AfterlifePatch
{
    ...
    [HarmonyPatch(typeof(Afterlife), nameof(Afterlife.CanonicalVars), MethodType.Getter)]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(Afterlife), nameof(Afterlife.CanonicalKeywords), MethodType.Getter)]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(Afterlife), nameof(Afterlife.OnPlay))]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(Afterlife), nameof(Afterlife.OnUpgrade))]
    [HarmonyPrefix]
    [UsedImplicitly]
