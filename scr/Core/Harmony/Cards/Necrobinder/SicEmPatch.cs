...
public static class SicEmPatch
{
    ...
    [HarmonyPatch(typeof(SicEm), nameof(SicEm.CanonicalVars), MethodType.Getter)]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(SicEm), nameof(SicEm.OnPlay))]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(SicEm), nameof(SicEm.OnUpgrade))]
    [HarmonyPrefix]
    [UsedImplicitly]
