...
public class PullAggroPatch
{
    ...
    [HarmonyPatch(typeof(PullAggro), nameof(PullAggro.CanonicalVars), MethodType.Getter)]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(PullAggro), nameof(PullAggro.OnPlay))]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(PullAggro), nameof(PullAggro.OnUpgrade))]
    [HarmonyPrefix]
    [UsedImplicitly]
