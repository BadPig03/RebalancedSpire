...
public static class SwordOfJadePatch
{
    ...
    {
        await PowerCmd.Apply<StrengthPower>(instance.Owner.Creature, instance.DynamicVars.Strength.BaseValue, null, null);
        await PowerCmd.Apply<DexterityPower>(instance.Owner.Creature, instance.DynamicVars.Dexterity.BaseValue, null, null);
    }
    ...
    [HarmonyPatch(typeof(SwordOfJade), nameof(SwordOfJade.CanonicalVars), MethodType.Getter)]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(SwordOfJade), nameof(SwordOfJade.ExtraHoverTips), MethodType.Getter)]
    [HarmonyPrefix]
    [UsedImplicitly]
