...
public static class AlchemicalCofferPatch
{
    ...
    [HarmonyPatch(typeof(AlchemicalCoffer), nameof(AlchemicalCoffer.CanonicalVars), MethodType.Getter)]
    [HarmonyPrefix]
    [UsedImplicitly]
    ...
    [HarmonyPatch(typeof(AbstractModel), nameof(AbstractModel.AfterPotionUsed))]
    [HarmonyPrefix]
    [UsedImplicitly]
